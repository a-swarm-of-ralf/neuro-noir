...
class Entity(BaseModel):
    name: str = Field(default="", alias="canonical_name", description="Canonical form of the entity. Prefer fully qualified names (e.g. 'Dr. John Watson' instead of 'Watson'). Try to resolve coreferences and use the most specific form of the name possible, for example if the text mentions 'the big cat' and later refers to it as 'the cat' or 'it', the canonical name should be 'big cat'.")
