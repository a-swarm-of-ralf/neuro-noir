...
def _(mo):
    ...
    This is Part 2 of the two-part workshop. In this section, you will focus on building intelligent tools and agents that reason over the knowledge graph to solve the murder mystery.
    ...
    After completing these steps, you will have a fully functional investigation agent capable of exploring evidence, reasoning about suspects, and presenting well-supported conclusions.
